...
=================================================================
================
WELCOME TO MPVM HOSPITALS PVT. LTD.
=================================================================
================
""")
...
#creating database
mycursor.execute("create database if not exists MPVM_hospital_dat")
mycursor.execute("use MPVM_hospital_dat")
#creating the tables we need
mycursor.execute("create table if not exists patient_details(name varchar(30) not null,sex varchar(3),age int(3),address varchar(50),contact varchar(15))")
...
""")
 ...
 for i in row:
  ...
  if a==2:
   ...
   4. EXIT
   """)
   b=int(input("ENTER YOUR CHOICE:")) #showing the existing details
...
""")
   ...
   if b==3:
    ...
    if bill=="y":
     ...
     mysql.commit() #if user wants to exit
   if b==4:
    break
   ###SIGN OUT
   if a==3:
